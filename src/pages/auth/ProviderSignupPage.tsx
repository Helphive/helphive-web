...
import { useProviderSignupMutation } from '@/features/auth/authApi';
...
export default function ProviderSignupPage() {
    const [signup, { isLoading }] = useProviderSignupMutation();
        ...
        return (
            <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography color="text.secondary" sx={{ mb: 4 }}>
                    We've sent a verification email to your inbox. After verifying your email,
                    you'll need to complete the provider onboarding process.
                </Typography>
                <Button
